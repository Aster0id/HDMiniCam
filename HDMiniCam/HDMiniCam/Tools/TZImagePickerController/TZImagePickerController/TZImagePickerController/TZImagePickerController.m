...
- (instancetype)initWithMaxImagesCount:(NSInteger)maxImagesCount delegate:(id<TZImagePickerControllerDelegate>)delegate fileType:(NSString *)fileType
{
    TZAlbumPickerController *albumPickerVc = [[TZAlbumPickerController alloc] init];
    self = [super initWithRootViewController:albumPickerVc];
    if (self) {
...
- (void)pushToPhotoPickerVc {
    ...
    if (_pushToPhotoPickerVc) {
        ...
        photoPickerVc.fileType = self.fileType;
