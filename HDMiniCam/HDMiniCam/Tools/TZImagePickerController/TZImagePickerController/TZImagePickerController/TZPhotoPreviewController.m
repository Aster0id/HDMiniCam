...
{
    _toolBar = [[UIView alloc] initWithFrame:CGRectMake(0, self.view.tz_height - 80, self.view.tz_width, 80)];

    if ([[UIDevice currentDevice] systemVersion].floatValue >= 13) {
        _toolBar.frame = CGRectMake(0, self.view.tz_height - 80, self.view.tz_width, 80);
    }
    else {
