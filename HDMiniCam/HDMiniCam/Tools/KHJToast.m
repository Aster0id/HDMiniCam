...
//  KHJCamera
//
//  Created by khj888 on 2018/12/3.
...
/**
 顶部 - toast，可点击
 */
- (void)showClickToastWithContent:(NSString *)content iconImage:(UIImage *)image block:(void(^)(void))block
{
    [self dismissToast];
    toast               = [[FFToast alloc] initToastWithTitle:nil message:content iconImage:image];
    toast.toastAlpha    = 1;
    toast.duration      = 2;
...
- (void)showOKBtnToastWith:(NSString *)tip content:(NSString *)content
{
    ...
    CGFloat okBtnW      = SCREEN_WIDTH - 2*horizontalSpaceToScreen - 80;
    CGFloat okBtnH      = 28;
