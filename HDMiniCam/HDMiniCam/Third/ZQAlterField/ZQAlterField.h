...
// 输入内容回调
// type 0 仅观看 1 观看，摇头，回放SD卡
typedef void(^ensureCallback)(NSString *inputString, int type);
...
/* 权限View */
@property (nonatomic, assign) BOOL needPermissionView;
@property (weak, nonatomic) IBOutlet UIView *permissionContentView;
@property (weak, nonatomic) IBOutlet NSLayoutConstraint *permissionViewCH;
