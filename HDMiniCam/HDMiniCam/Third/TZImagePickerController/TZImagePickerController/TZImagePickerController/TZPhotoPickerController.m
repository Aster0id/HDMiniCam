...
- (void)viewDidLoad {
    ...
    self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:KHJLocalizedString(@"cancel_", nil) style:UIBarButtonItemStylePlain target:self action:@selector(cancel)];
...
- (void)configBottomToolBar
{
    ...
    if ([[UIDevice currentDevice] systemVersion].floatValue >= 13) {
        bottomToolBar.frame = CGRectMake(0, self.view.tz_height - 90, self.view.tz_width, 90);
    }
    else {
        bottomToolBar.frame = CGRectMake(0, self.view.tz_height - 50, self.view.tz_width, 50);
    }
    ...
    if (imagePickerVc.allowPickingOriginalPhoto) {
        ...
        _originalPhotoButton.frame = CGRectMake(50, 3, 130, 44);
    ...
    [_okButton setTitle:KHJLocalizedString(@"sure", nil) forState:UIControlStateNormal];
    [_okButton setTitle:KHJLocalizedString(@"sure", nil) forState:UIControlStateDisabled];
